    ...
    return (
        <div className='flex justify-between items-center mt-20 mb-5'>
            ...
            <div className="inline-flex rounded-xl border border-gray-300 overflow-hidden">
                ...
                <button className="px-6 py-3 text-sm font-semibold transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-[#E7FE29] bg-white text-black rounded-r-xl">Selected ({playerCount})</button>
